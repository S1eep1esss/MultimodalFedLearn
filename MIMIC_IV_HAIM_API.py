...
# core_mimiciv_path = r'/Modality Gen/Mimic-iv/physionet.org/files/mimiciv/3.1'
core_mimiciv_path = r'C:/internship/Research/Modality Gen/Mimic-iv/physionet.org/files/mimiciv/3.1'

# Define MIMIC IV Image Data Location (usually external drive)
# core_mimiciv_imgcxr_path = r'Modality Gen\Mimic-CXR-jpg'
core_mimiciv_imgcxr_path = r'C:/internship/Research/Modality Gen/physionet.org/files/mimic-cxr-jpg/2.1.0/files/p10'
