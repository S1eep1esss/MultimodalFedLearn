...
class Note_dataset(Dataset):
    def __init__(self, split='train', data_path = 'cleaned_data', regenerate=True, task='mortality'):
        ...
        if regenerate:
            ...
            data = pd.read_csv('C:/internship/Research/Modality Gen/physionet.org/files/mimic-iv-note/2.2/note/filter/radiology.csv').dropna()
